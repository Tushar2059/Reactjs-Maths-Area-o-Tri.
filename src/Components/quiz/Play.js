...
//import "../Components/Activities/ActFolder1/Mid.css"
import "../Activities/ActFolder1/Mid.css";
...
class Play extends React.Component {
  ...
  handleSubmitClick = (e) => {
    if(this.state.optionChoosen.toLowerCase().replace(/ /g,'').length === 0){
      ...
      if ( this.state.optionChoosen.toLowerCase().replace(/ /g,'') === this.state.answer.toLowerCase().replace(/ /g,'')) 
      {
        setTimeout(() => {
  ...
  renderRedirect = () => {
    if (this.state.redirect) {
      return <Navigate to="/activity11/letusverify" />;
    }
  };
...
//             <h6>
//               {" "}
//               Your Scored {this.state.score} out of{" "}
